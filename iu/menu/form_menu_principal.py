...
from iu.archivos.form_cargar_archivo import CargarArchivoView
...
class MenuPrincipalView(VentanaBase):
    ...
    def _crear_widgets(self):
        ...
        ttk.Button(
            ...
            width=35,
            command=lambda: CrearPeriodoView(self.master)
        ).pack(pady=6)
        ...
        ttk.Button(
            ...
            width=35,
            command=lambda: ListarPeriodosView(self.master)
        ).pack(pady=6)
        ...
        ttk.Button(
            ...
            width=35,
            command=lambda: ConfigurarCarreraView(self.master)
        ).pack(pady=6)
        ...
        ttk.Button(
            ...
            width=35,
            command=lambda: VerOfertaAcademicaView(self.master)
        ).pack(pady=6)
        ...
        ttk.Button(
            ...
            width=35,
            command=lambda: CargarPostulantesView(self.master)
        ).pack(pady=6)
        ...
        ttk.Button(
            ...
            width=35,
            command=lambda: EjecutarAsignacionView(self.master)
        ).pack(pady=6)
        ...
        ttk.Button(
            ...
            text="Ver resultados",
            width=35,
            command=lambda: VerResultadosView(self.master)
        ).pack(pady=6)
        ...
        ttk.Button(
            ...
            width=35,
            command=lambda: ExportarResultadosView(self.master)
        ).pack(pady=6)
